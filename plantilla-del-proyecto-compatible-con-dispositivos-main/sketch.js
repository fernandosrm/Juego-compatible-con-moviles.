...
function createCash() {
  if (World.frameCount % 200 == 0) {
   //Modificar las posiciones del dinero 
    var cash = createSprite(Math.round(random(width+200, height-350),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(width+200, height-350),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(width+200, height-350),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(width+50, height-350),40, 10, 10));
